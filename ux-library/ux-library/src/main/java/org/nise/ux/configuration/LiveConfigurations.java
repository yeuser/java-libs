...
public class LiveConfigurations extends FileConfigurations implements Runnable {
  ...
  private final StatusProfiler status           = new StatusProfiler();
  private final OutputProfiler output           = new OutputProfiler();

  public LiveConfigurations(int config_live_port, int status_live_port, int output_live_port, String config_conf, String[][] all_keys_defualts) {
